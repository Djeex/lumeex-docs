...
description: Configure your Lumeex site without the WebUI, setting metadata, social links, navigation menu, footer, legal notice, and build options in site.yaml.
main:
  fluid: false
---
