---
title: Home
description: Lumeex is a minimalist, lightweight static site generator for photo galleries, with tag-based filtering, random photo order, and a browser-based WebUI builder.
navigation: false
layout: page
main:
  fluid: false
...
cta:
  - 🚀 Quick Start
  - https://lumeex.djeex.fr/online-builder
secondary:
  - Try the demo ↓
  - /#demo
---
...
#extra
  ...
  - Legal notice page.
  - [Online builder WebUI](https://lumeex.djeex.fr/online-builder) (it runs entirely in your browser)
  - Or build locally from a docker WebUI, or CLI !
  ::
#support
...
<h2 id="demo">Build locally with docker or python environment</h2>

Lumeex is an open-source project. You can deploy it locally on your computer or server to fit your workflow.

::card-grid
#root
:ellipsis{left=0px width=40rem top=10rem blur=140px}
#title
Build locally with docker or python environment
#default
  ::card{icon=fluent-color:book-open-16}
  #title
  Documentation
  #description
