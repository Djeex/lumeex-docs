...
description: Configure your Lumeex photo gallery without the WebUI, adding photos, generating references with the gallery command, and tagging images in gallery.yaml.
main:
  fluid: false
---
